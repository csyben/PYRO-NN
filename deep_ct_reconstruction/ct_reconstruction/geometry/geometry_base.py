...
class GeometryBase:
    ...
    def __init__(self,
        ...
        # Volume Parameters:
        self.volume_shape = np.array(volume_shape, dtype=self.np_dtype)
        ...
        # Detector Parameters:
        self.detector_shape = np.array(detector_shape, dtype=self.np_dtype)
        ...
        self.sinogram_shape = np.array([self.number_of_projections, *self.detector_shape], dtype=self.np_dtype)
